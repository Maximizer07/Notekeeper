...
function Footer(props) {
    ...
    return (
        <footer className="text-center mb-4">
            <Container className="text-white text-muted" py-lg="5" py="4">
                {props.auth ? (
                    ...
                    <ul className="list-inline">
                        ...
                        <li className="list-inline-item"><Link className="link-secondary" to="/login">Login</Link>
                        </li>
                    </ul>
                )}
                <ul className="list-inline">
            ...
            <ModalWindow header="Готово" body="Вы успешно вышли из аккаунта" show ={show} action={handleClose} close = {handleClose}/>
        </footer>
