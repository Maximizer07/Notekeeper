...
function Profile() {
    ...
    const findFormErrorsProfile = () => {
        ...
        if (!formEmail || formEmail === '') newErrors.email = 'Пожалуйста введите почту'
        else if (!validator.isEmail(formEmail)) newErrors.email = 'Не корректная запись почты'
                            ...
                            <Form onSubmit={handleSubmit} noValidate>
                                <Row className="mb-3">
                                    ...
                                    <Form.Group as={Col} controlId="name">
                                        ...
                                        <Form.Control type="text" placeholder="Enter Name" defaultValue={form.formName}
                                ...
                                <Row className="mb-3">
                                    <Form.Group as={Col} controlId="email">
                                        ...
                                        <Form.Control type="email" placeholder="Enter email" defaultValue={form.formEmail}
                                                      isInvalid={errors.formEmail} disabled={disabled}
                                                      onChange={e => {
                                                          setField('formEmail', e.target.value)
                                                      }}/>
                                        <Form.Control.Feedback type='invalid'>{errors.formEmail}</Form.Control.Feedback>
                                    </Form.Group>
                                </Row>
